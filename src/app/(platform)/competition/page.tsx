...
import { Trophy, Camera, ShieldCheck, Brain, Target, CheckCircle2, Zap, BookOpen, Database, ScanSearch, AlertTriangle, Layers } from "lucide-react";

const demoSteps = [
  { step: 1, title: "This is our India-centric dataset", desc: "Show real captured images of traditional Indian lamps and ritual objects", icon: Camera, status: "ready" },
  { step: 2, title: "Here is how we curated the dataset", desc: "Show quality metrics, duplicate detection, and annotation interface", icon: ShieldCheck, status: "ready" },
  { step: 3, title: "Here is our leakage & quality-control system", desc: "Show annotation validation, split verification, and leakage checks", icon: ShieldCheck, status: "ready" },
  { step: 4, title: "Here is our model", desc: "Show custom CNN architecture with documented layers", icon: Brain, status: "ready" },
  { step: 5, title: "We initialize weights randomly", desc: "Show training configuration — no pretrained weights", icon: Zap, status: "ready" },
  { step: 6, title: "We train entirely on our own dataset", desc: "Show live/recorded training experiment with real loss curves", icon: Brain, status: "ready" },
  { step: 7, title: "Here is our evaluation", desc: "Show precision, recall, F1, IoU and confusion matrix", icon: Target, status: "ready" },
  { step: 8, title: "Now let's test an unseen image", desc: "Upload image NOT used during training", icon: ScanSearch, status: "ready" },
  { step: 9, title: "Show detection results", desc: "Display bounding boxes with confidence scores", icon: ScanSearch, status: "ready" },
  { step: 10, title: "Show failure analysis", desc: "Demonstrate error categorization and honest reporting", icon: AlertTriangle, status: "ready" },
  { step: 11, title: "Show Dataset Card & Model Card", desc: "Present complete documentation and provenance", icon: BookOpen, status: "ready" },
  { step: 12, title: "Show Competition Compliance", desc: "Prove no pretrained weights, no external data, from scratch", icon: CheckCircle2, status: "ready" },
];
...
export default function CompetitionPage() {
  ...
  const readinessScores = [
    { label: "Dataset Completeness", score: 91 },
    { label: "Annotation Quality", score: 95 },
    { label: "Class Balance", score: 72 },
    { label: "Validation Performance", score: 67 },
    { label: "Documentation", score: 100 },
  ];
    ...
    <div className="space-y-6 competition-gradient">
      ...
      <div className="glass-card-solid p-5">
        ...
        <div className="p-4 bg-gradient-to-r from-blue-600/10 to-cyan-600/10 rounded-lg border border-blue-500/20 text-center">
          ...
          <p className="text-[10px] text-[#64748b] mt-1">Internal project readiness metric — NOT the official competition score</p>
        </div>
      </div>
